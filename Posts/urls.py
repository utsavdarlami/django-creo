...
urlpatterns = [
    ...
    path('<int:id>/',views.detailpost,name="detailpost"),#calls detailpost function of views.py
    #Posts 
    path('<int:pk>/update/',views.PostUpdateView.as_view(),name="updatepost"),#calls UpdateProfile function of views.py
    path('<int:pk>/delete/',views.PostDeleteView.as_view(),name="deletepost"),#calls UpdateProfile function of views.py
    path('submission/',views.PostFormView.as_view(),name="post"),#calls PostFormView create class view of views.py
    #rate and revew
