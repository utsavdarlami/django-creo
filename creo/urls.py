...
urlpatterns = [
    ...
    path('userupdate/<int:pk>',views.UserUpdateView.as_view(),name="updateprofile"),
    path('portfolioupdate/<int:pk>',views.UserProfileUpdateView.as_view(),name="updateportfolio"),
    path('editprofile/',views.UpdateProfile,name="updateprofile"),
